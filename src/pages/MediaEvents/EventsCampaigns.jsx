            ...
            <div className="events-page">
                ...
                <div className="card-flat bg-dark text-light mb-8" style={{ borderRadius: 'var(--radius-md)', padding: '4rem 3rem', display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '2rem', alignItems: 'center' }}>
                    <div>
                        ...
                        <button className="btn btn-primary" style={{ backgroundColor: 'var(--secondary-accent)', color: 'var(--text-primary)' }}
                            onClick={() => {
                ...
                {/* Upcomming Events */}
                <div className="mb-8">
                    <h3 className="mb-4" style={{ marginTop: '70px' }}>Upcoming Programmes</h3>
                ...
                {/* Campaign Categories */}
                <div className="section-padding bg-primary-light" style={{ borderRadius: 'var(--radius-md)', padding: '4rem 2rem', marginTop: '70px' }}>
                    ...
                    <div className="grid-2">
                        {categories.map((cat, idx) => (
                            <div key={idx} className="bg-white" style={{ padding: '2rem', borderRadius: 'var(--radius-md)', display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                                <div className="bg-sand" style={{ padding: '1rem', borderRadius: '12px', marginTop: '20px' }}>
                ...
                {/* CTA */}
                <div id="newsletter"
                    className="mt-8 text-center bg-accent" style={{ padding: '4rem 2rem', borderRadius: 'var(--radius-md)', marginTop: '70px' }}>
