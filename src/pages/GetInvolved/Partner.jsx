  ...
  return (
    ...
    >
      <div className="partner-page">
        ...
        <div className="grid-3 mb-8" style={{ marginTop: '50px', marginBottom: '50px' }}>
        ...
        <div className="section-padding bg-primary-light" style={{ borderRadius: 'var(--radius-md)', padding: '4rem 3rem', marginBottom: '50px' }}>
