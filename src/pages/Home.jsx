...
import { Heart, Users, BookOpen, HandHeart, ArrowRight, CheckCircle2, Star, Quote } from 'lucide-react';
import './Home.css';

// Assets
import heroImage from '../assets/hero_main.png';
import elderlyImage from '../assets/elderly_care_main.png';
import foodDistImage from '../assets/WhatsApp Image 2026-03-07 at 05.20.49.jpeg';
import childLearningImage from '../assets/smiling-children-different-ethnicities-learning-outdoors-generated-by-ai.jpg';
import volunteerImage from '../assets/volunteer-helping-with-donation-box.jpg';
import healthCampImage from '../assets/WhatsApp Image 2026-03-10 at 01.28.01.jpeg';
...
export default function Home() {
  return (
    <div className="home-page">
          ...
          <div className="hero-content animate-fade-in">
            ...
            <div className="hero-trust mt-4 flex align-center gap-small">
              <div className="trust-portraits">
                 <div className="portrait-circle">10k+</div>
              </div>
              <p className="m-0 text-secondary">Join over <span className="font-bold">10,000+</span> active members & supporters</p>
            </div>
          </div>
          <div className="hero-media">
            <div className="hero-image-wrapper">
              <img src={heroImage} alt="GWA Community Support" className="hero-main-img" />
              <div className="hero-accent-box bg-accent">
                 <div className="impact-number font-bold">15+</div>
      ...
      {/* About Section - Impactful Success */}
      <section className="home-impact section-padding">
        <div className="container">
          <div className="grid-2 align-center">
            <div className="impact-visuals">
              <div className="impact-img-primary">
                <img src={elderlyImage} alt="Elderly Care" className="img-round-lg shadow-lg" />
              </div>
              <div className="impact-img-secondary">
                 <img src={foodDistImage} alt="Food Drive" className="img-round-lg shadow-lg" />
              </div>
              <div className="success-badge bg-primary-brand text-light">
                 <Star size={24} className="text-accent" />
                 <div>
                   <h3 className="m-0 text-light">12.5k</h3>
            ...
            <div className="impact-content">
              ...
              <Link to="/about/overview" className="btn btn-primary">Discover More</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mission-vision section-padding bg-sand">
        <div className="container">
          <div className="text-center mb-4">
             ...
             <h2>Empowering Lives Since <span className="text-primary-brand">2008</span></h2>
          </div>
          ...
          <div className="vision-grid-complex">
             <div className="vision-card card-flat card-hover-up">
                ...
                <Link to="/about/vision-mission" className="btn-text text-primary-brand">Read More <ArrowRight size={16}/></Link>
             </div>
          ...
          <div className="grid-3">
             <div className="project-card">
                <div className="project-img-wrapper">
                   <img src={foodDistImage} alt="Food Drive" className="project-img" />
             ...
             <div className="project-card">
                <div className="project-img-wrapper">
                   ...
                   <div className="project-tag">Healthcare</div>
                </div>
                <div className="project-details">
                   <h4>Free Medical Camp Organised</h4>
                   <p className="text-secondary">Focused on senior citizens and diagnostic tests.</p>
                   <Link to="/work-areas/healthcare" className="btn-text">Learn More <ArrowRight size={16}/></Link>
                </div>
             </div>
