            ...
            <div className="about-page">
                ...
                <div className="max-w-4xl mx-auto">
                    {levels.map((level, idx) => (
                        <div key={idx} className="flex gap-large mb-6 items-start">
                            <div className="hidden md:flex flex-col items-center" style={{ minWidth: '60px', marginTop: '70px' }}>
                                <div className="w-10 h-10 rounded-full bg-primary-brand text-white flex items-center justify-center font-bold">
                                    {idx + 1}
                                </div>
                                {idx !== levels.length - 1 && <div className="w-0.5 h-full bg-primary-bg my-2"></div>}
                            </div>
                            <div className="card-flat flex-grow p-6 flex align-start gap-6 card-hover-up" style={{ marginBottom: '50px' }}>
                                <div className="p-2 rounded-xl text-primary-brand flex-shrink-0" style={{ marginRight: '20px', marginTop: '30px' }}>
                                    {level.icon}
                                </div>
                                <div>
