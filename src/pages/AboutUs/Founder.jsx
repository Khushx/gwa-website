...
export default function Founder() {
  return (
    <PageLayout title="Founder & President" subtitle="The visionary leadership behind Ghatkopar Welfare Association.">
      <div className="about-page">
        <div className="profile-card">
          ...
          <div className="profile-details">
            ...
            <p className="text-primary-brand font-bold mb-6">Founder & President, GWA</p>
